...
## 介绍
在采集一些网站时，我们需要批量生成一批网址。 比如我们采集搜索引擎时，要许多不同关键词的搜索结果。我们以百度搜索为例，展示如何采集多关键词搜索结果。
...
4. **时间**，按照指定的时间格式生成一个区间的时间集合。
5. **时间点**，按照指定的时间格式生成一个时间点。
...
在设置完生成网址后，可以点击 `预览网址`，查看生成的网址结果。
![urlparam](img/urls_4.png)
